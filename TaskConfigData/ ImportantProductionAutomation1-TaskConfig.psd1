...
#>
@{
    TaskName    = 'ExampleRepo- ImportantProductionAutomation1'
    TaskPath    = '\PSCAutomation\'
    Description = ' ImportantProductionAutomation1.ps1'
    TaskAction  = @{
        Execute                         = 'powershell.exe' 
        Argument                        = "-WindowStyle Hidden -File 'C:\git\ ImportantProductionAutomation1.ps1'  "
